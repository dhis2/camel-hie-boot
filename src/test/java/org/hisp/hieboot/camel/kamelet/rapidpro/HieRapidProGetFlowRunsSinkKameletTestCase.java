...
public class HieRapidProGetFlowRunsSinkKameletTestCase extends AbstractHieRapidProKameletTestCase {
        ...
        camelContext.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                from("direct:routeUnderTest")
                        .to(String.format("kamelet:hie-rapidpro-get-flow-runs-sink?rapidProApiUrl=%s&rapidProApiToken=%s", RAPIDPRO_API_URL, RAPIDPRO_API_TOKEN))
                        .split(body())
                        .to("mock:verify");
            }
        });
