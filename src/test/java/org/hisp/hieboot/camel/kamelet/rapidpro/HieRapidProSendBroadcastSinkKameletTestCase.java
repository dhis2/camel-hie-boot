...
public class HieRapidProSendBroadcastSinkKameletTestCase extends AbstractHieRapidProKameletTestCase {
        ...
        camelContext.addRoutes(new RouteBuilder() {
            ...
            public void configure() {
                from("direct:routeUnderTest")
                        ...
                        .to(String.format("kamelet:hie-rapidpro-send-broadcast-sink?rapidProApiUrl=%s&rapidProApiToken=%s", RAPIDPRO_API_URL, RAPIDPRO_API_TOKEN))
                        .to("mock:verify");
            }
        });
